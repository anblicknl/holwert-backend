...
const styles = StyleSheet.create({
  ...
  hero: { width: '100%', resizeMode: 'cover', borderBottomLeftRadius:24, borderBottomRightRadius:24 },
  heroWrap: { position:'relative', width:'100%', borderBottomLeftRadius:24, borderBottomRightRadius:24, overflow:'visible' },
  iconBtnFabOverlay: { position:'absolute', right: 16, bottom: -22, width:48, height:48, borderRadius:24, alignItems:'center', justifyContent:'center', backgroundColor:'#fff', borderWidth:1, borderColor:'#dbe1f0', shadowColor:'#000', shadowOpacity:0.12, shadowRadius:14, zIndex: 20, elevation: 6 },
