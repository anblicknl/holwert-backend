                    ...
                    <div class="form-group">
                        ...
                        ${(weekdayLabels || []).map((label, day) => {
                            ...
                            return `<div class="form-row" style="align-items:center;margin-bottom:8px;gap:8px;">
                                <span style="min-width:100px;font-weight:500;">${esc(label)}</span>
                                ...
                                <input type="time" class="pb-day-start" data-day="${day}" value="${esc(d.open || '09:00')}" ${isOpen ? '' : 'disabled'} style="flex:1;">
                                <span style="padding:0 2px;">–</span>
                                <input type="time" class="pb-day-end" data-day="${day}" value="${esc(d.close || '17:00')}" ${isOpen ? '' : 'disabled'} style="flex:1;">
                            </div>`;
                        }).join('')}
                    </div>`;
