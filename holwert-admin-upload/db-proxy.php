...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['check'])) {
    ...
    echo json_encode([
        ...
        'tables' => ['bookmarks', 'push_notification_mutes', 'follows', 'push_tokens', 'users', 'organizations', 'news', 'events', 'content_pages', 'practical_info', 'afvalkalender_config', 'org_password_resets', 'app_password_resets', 'organization_profile_blocks'],
    ]);
    exit;
}
